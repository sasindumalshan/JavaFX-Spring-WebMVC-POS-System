...
import lk.interleon.pos.controller.CategoryFromController;
import lk.interleon.pos.controller.UnitFromController;
    ...
    public Button getAction() {
        ...
        button.setOnAction(actionEvent -> {
            ...
            if (alert.getResult().equals(ButtonType.YES)) {
                ...
                if(UnitModel.remove(this.id)) {
                    UnitFromController.getController().loadAll();
